                                    ...
                                    <div class="col-auto mt-4">
                                        ...
                                        <nav aria-label="breadcrumb">
                                            <ul class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active"><a href="#">Thêm thông tin sinh viên</a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form  action="/create" method="post">
                                    ...
                                    <input class="form-control mb-2" name="fullname" type="text" placeholder="FullName" value="">
                                    <input class=" form-control mb-2" name="birthday" type="text" placeholder="Birthday" value="">
                                    <input class=" form-control mb-2" name="address" type="text" placeholder="Address" value="">
